    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 bg-violet-400'>
        <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white text-gray-700 font-semibold'>
            <div>
                ...
                <p className='max-w-[410px] mt-6'>PostCraft blends creativity with clarity — turning ordinary words into powerful experiences. Whether you're writing to inspire, inform, or ignite action, our tools help your message land with meaning.
                Because every phrase deserves to be felt.</p>
            </div>
